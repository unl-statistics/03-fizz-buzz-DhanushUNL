...
fizzbuzz(x = c(12.0,23,44.0)) ## works for "doubles" if sb accidentally input any. eg: 23.0 will be identified as double
...
x1 = np.array([1,7,54,32.0,29.0]) ## works for "floats" if sb accidentally input any. eg: 23.0 will be identified as float
